...
<head>
    ...
    <title>PC Builder | Storage</title>
...
<body>
    ...
    $sql = "SELECT * FROM storage WHERE 1=1";
    $countSql = "SELECT COUNT(*) FROM storage WHERE 1=1";
    ...
    echo "<form action='storage.php' method='get'>
        Brand: <select name='type'>
            <option value=''>All Type</option>
            <option value='NVME'" . ($typeFilter == 'NVME' ? ' selected' : '') . ">NVME</option>
            <option value='SATA'" . ($typeFilter == 'SATA' ? ' selected' : '') . ">SATA</option>
            <option value='HDD'" . ($typeFilter == 'HDD' ? ' selected' : '') . ">HDD</option>
        </select>
